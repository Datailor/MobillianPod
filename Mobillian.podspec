#
#  Be sure to run `pod spec lint Mobillian.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Datailor" => "info@datailor.net" }
  # Or just: spec.author    = "ahmeturhan"
  # spec.authors            = { "ahmeturhan" => "ahmet.han@datailor.net" }
  # spec.social_media_url   = "https://twitter.com/ahmeturhan"
